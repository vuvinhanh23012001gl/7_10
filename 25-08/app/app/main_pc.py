                ...
                case 1:
                    ...
                    if(is_run == 1): 
                        ...
                        if "0" == choose_master_index:
                                queue_tx_web_log.put("❌Bạn chưa chọn loại sản phẩm. Cần \"Chọn loại sản phẩm\" trước khi nhấn \"Chạy\"!")
                        ...
                        if arr_point:
                                ...
                                queue_tx_web_log.put("❌Hiện tại sàn phẩm này chưa được cấu hình master. Hãy vào \"Cấu hình master->Chỉnh sửa master->Thêm master\" để cấu hình cho sản phẩm")
